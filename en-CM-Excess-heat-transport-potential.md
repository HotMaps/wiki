...
More information about the annual heat demand and DH potential can be found here [DH Potential CM](https://github.com/HotMaps/hotmaps_wiki/wiki/en-CM-District-heating-potential-areas-user-defined-thresholds).
The excess heat, connected excess heat and used excess heat are the same as their equally named indicators.
