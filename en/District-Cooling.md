...
### Create an account for the Hotmaps toolbox. You can find a description of the procedure to do so under the following [link](/en/Introduction-to-user-interface).
