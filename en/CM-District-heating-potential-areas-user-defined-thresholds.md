...
The "CM - DISTRICT HEATING POTENTIAL AREA: USER-DEFINED THRESHOLD" determines the DH areas and their corresponding DH potential based on heat demand densities. The heat demand densities are obtained from an input GIS layer. The Hotmaps toolbox and database provides a default heat density map that can be used in this calculation module, namely **[European Heat Density Map (EHDM)](https://gitlab.com/hotmaps/heat/heat_tot_curr_density)**. It was developed in course of the **[Hotmaps project](https://www.hotmaps-project.eu)**. The EHDM is in raster format and has a resolution of one hectare and Coordinate Reference System (CRS) of "_*ETRS89 / LAEA Europe - EPSG 3035*_". The cells in EHDM show the heat densities in _**MWh/ha**_. Besides this default map also maps generated by the user can be uploaded to the toolbox and used in this CM.
